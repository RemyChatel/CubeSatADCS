#ifndef MPU9150_H
#define MPU9150_H
#include "MPU9150_registrer_map.h"
#include "mbed.h"
 ...
 // but all these rates are further reduced by a factor of 5 to 200 Hz because of the SMPLRT_DIV setting
  ...
  // can join the I2C bus and all can be controlled by the Arduino as master
   ...
   writeByte(MPU9150_ADDRESS, INT_ENABLE, 0x01);  // Enable data ready (bit 0) interrupt
    ...
    mRes = 1229./4096.; // Conversion to 1229 microTesla full scale (4096)
    ...
    magbias[1] = -9.5;  // User environmental y-axis correction in milliGauss
    magbias[2] = -26.0; // User environmental z-axis correction in milliGauss
}
