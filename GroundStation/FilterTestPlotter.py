...
pl.subplot(2,2,1)
pl.plot(t, quat_no[0,:], label='Measured', linestyle='dashed', color='grey')
...
pl.legend()
pl.subplot(2,2,2)
pl.plot(t, quat_no[1,:], label='Measured', linestyle='dashed', color='grey')
...
pl.legend()
pl.subplot(2,2,3)
pl.plot(t, quat_no[2,:], label='Measured', linestyle='dashed', color='grey')
...
pl.legend()
pl.subplot(2,2,4)
pl.plot(t, quat_no[3,:], label='Measured', linestyle='dashed', color='grey')
...
pl.subplot(2,2,2)
pl.plot(t, omega_no[2,:], label='Measured', linestyle='dashed', color='grey')
