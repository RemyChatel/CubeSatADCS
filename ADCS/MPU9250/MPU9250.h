...
class MPU9250 {
    public:
         ...
         void getAccel(float *acc);
         void getGyro(float * gyr);
         ...
         void MadgwickQuaternionUpdate(float acc[3], float gyro[3], float mag[3], float deltat, float q[4]);
         void MahonyQuaternionUpdate(float acc[3], float gyro[3], float mag[3], float deltat, float q[4]);
