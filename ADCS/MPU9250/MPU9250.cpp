...
void MPU9250::getAccel(float *acc){
...
void MPU9250::getGyro(float * gyr){
    readGyroData(gyroCount);  // Read the x/y/z adc values
    // Calculate the gyro value into actual degrees per second
    gyr[0] = (float)gyroCount[0]*gRes - gyroBias[0];  // get actual gyro value, this depends on scale being set
    gyr[1] = (float)gyroCount[1]*gRes - gyroBias[1];  
    gyr[2] = (float)gyroCount[2]*gRes - gyroBias[2];
}
...
void MPU9250::MadgwickQuaternionUpdate(float acc[3], float gyr[3], float mag[3], float deltat, float q[4]){
    ...
    norm = sqrt(mag[0] * mag[0] + mag[0] * mag[0] + mag[0] * mag[0]);
    if (norm == 0.0f) return; // handle NaN
    norm = 1.0f/norm;
    mag[0] *= norm;
    mag[0] *= norm;
    ...
    _2q1mx = 2.0f * q1 * mag[0];
     _2q1my = 2.0f * q1 * mag[0];
    _2q1mz = 2.0f * q1 * mag[0];
    _2q2mx = 2.0f * q2 * mag[0];
    hx = mag[0] * q1q1 - _2q1my * q4 + _2q1mz * q3 + mag[0] * q2q2 + _2q2 * mag[0] * q3 + _2q2 * mag[0] * q4 - mag[0] * q3q3 - mag[0] * q4q4;
    hy = _2q1mx * q4 + mag[0] * q1q1 - _2q1mz * q2 + _2q2mx * q3 - mag[0] * q2q2 + mag[0] * q3q3 + _2q3 * mag[0] * q4 - mag[0] * q4q4;
    _2bx = sqrt(hx * hx + hy * hy);
    _2bz = -_2q1mx * q3 + _2q1my * q2 + mag[0] * q1q1 + _2q2mx * q4 - mag[0] * q2q2 + _2q3 * mag[0] * q4 - mag[0] * q3q3 + mag[0] * q4q4;
    _4bx = 2.0f * _2bx;
    _4bz = 2.0f * _2bz;

    // Gradient decent algorithm corrective step
    s1 = -_2q3 * (2.0f * q2q4 - _2q1q3 - acc[0]) + _2q2 * (2.0f * q1q2 + _2q3q4 - acc[1]) - _2bz * q3 * (_2bx * (0.5f - q3q3 - q4q4) + _2bz * (q2q4 - q1q3) - mag[0]) + (-_2bx * q4 + _2bz * q2) * (_2bx * (q2q3 - q1q4) + _2bz * (q1q2 + q3q4) - mag[0]) + _2bx * q3 * (_2bx * (q1q3 + q2q4) + _2bz * (0.5f - q2q2 - q3q3) - mag[0]);
    s2 = _2q4 * (2.0f * q2q4 - _2q1q3 - acc[0]) + _2q1 * (2.0f * q1q2 + _2q3q4 - acc[1]) - 4.0f * q2 * (1.0f - 2.0f * q2q2 - 2.0f * q3q3 - acc[2]) + _2bz * q4 * (_2bx * (0.5f - q3q3 - q4q4) + _2bz * (q2q4 - q1q3) - mag[0]) + (_2bx * q3 + _2bz * q1) * (_2bx * (q2q3 - q1q4) + _2bz * (q1q2 + q3q4) - mag[0]) + (_2bx * q4 - _4bz * q2) * (_2bx * (q1q3 + q2q4) + _2bz * (0.5f - q2q2 - q3q3) - mag[0]);
    s3 = -_2q1 * (2.0f * q2q4 - _2q1q3 - acc[0]) + _2q4 * (2.0f * q1q2 + _2q3q4 - acc[1]) - 4.0f * q3 * (1.0f - 2.0f * q2q2 - 2.0f * q3q3 - acc[2]) + (-_4bx * q3 - _2bz * q1) * (_2bx * (0.5f - q3q3 - q4q4) + _2bz * (q2q4 - q1q3) - mag[0]) + (_2bx * q2 + _2bz * q4) * (_2bx * (q2q3 - q1q4) + _2bz * (q1q2 + q3q4) - mag[0]) + (_2bx * q1 - _4bz * q3) * (_2bx * (q1q3 + q2q4) + _2bz * (0.5f - q2q2 - q3q3) - mag[0]);
    s4 = _2q2 * (2.0f * q2q4 - _2q1q3 - acc[0]) + _2q3 * (2.0f * q1q2 + _2q3q4 - acc[1]) + (-_4bx * q4 + _2bz * q2) * (_2bx * (0.5f - q3q3 - q4q4) + _2bz * (q2q4 - q1q3) - mag[0]) + (-_2bx * q1 + _2bz * q3) * (_2bx * (q2q3 - q1q4) + _2bz * (q1q2 + q3q4) - mag[0]) + _2bx * q2 * (_2bx * (q1q3 + q2q4) + _2bz * (0.5f - q2q2 - q3q3) - mag[0]);
 ...
 // measured ones. 
void MPU9250::MahonyQuaternionUpdate(float acc[3], float gyr[3], float mag[3], float deltat, float q[4]){
    ...
    // Reference direction of Earth's magnetic field
    hx = 2.0f * mag[0] * (0.5f - q3q3 - q4q4) + 2.0f * mag[0] * (q2q3 - q1q4) + 2.0f * mag[0] * (q2q4 + q1q3);
    hy = 2.0f * mag[0] * (q2q3 + q1q4) + 2.0f * mag[0] * (0.5f - q2q2 - q4q4) + 2.0f * mag[0] * (q3q4 - q1q2);
    bx = sqrt((hx * hx) + (hy * hy));
    bz = 2.0f * mag[0] * (q2q4 - q1q3) + 2.0f * mag[0] * (q3q4 + q1q2) + 2.0f * mag[0] * (0.5f - q2q2 - q3q3);
    ...
    ex = (acc[1] * vz - acc[2] * vy) + (mag[0] * wz - mag[0] * wy);
    ey = (acc[2] * vx - acc[0] * vz) + (mag[0] * wx - mag[0] * wz);
    ez = (acc[0] * vy - acc[1] * vx) + (mag[0] * wy - mag[0] * wx);
    if (Ki > 0.0f){
    ...
    gyr[0] = gyr[0] + Kp * ex + Ki * eInt[0];
    gyr[1] = gyr[1] + Kp * ey + Ki * eInt[1];
    gyr[2] = gyr[2] + Kp * ez + Ki * eInt[2];

    // Integrate rate of change of quaternion
    pa = q2;
    pb = q3;
    pc = q4;
    q1 = q1 + (-q2 * gyr[0] - q3 * gyr[1] - q4 * gyr[2]) * (0.5f * deltat);
    q2 = pa + (q1 * gyr[0] + pb * gyr[2] - pc * gyr[1]) * (0.5f * deltat);
    q3 = pb + (q1 * gyr[1] - pa * gyr[2] + pc * gyr[0]) * (0.5f * deltat);
    q4 = pc + (q1 * gyr[2] + pa * gyr[1] - pb * gyr[0]) * (0.5f * deltat);
