...
pl.subplot(2,2,1)
pl.plot(t, quat_no[0,:], label='Measured', color='grey')
pl.plot(t, quat_th[0,:], label='Noisy estimation')
pl.plot(t, quat_pred[0,:], label='Filtered prediction', linestyle='dashed')
pl.legend()
pl.xlabel("Time (s)")
pl.ylabel(r"$\eta$")
pl.grid(True)
...
pl.legend()
pl.subplot(2,2,2)
pl.plot(t, quat_no[1,:], label='Measured', color='grey')
pl.plot(t, quat_th[1,:], label='Noisy estimation')
pl.plot(t, quat_pred[1,:], label='Filtered prediction', linestyle='dashed')
pl.xlabel("Time (s)")
...
pl.legend()
pl.subplot(2,2,3)
pl.plot(t, quat_no[2,:], label='Measured', color='grey')
pl.plot(t, quat_th[2,:], label='Noisy estimation')
pl.plot(t, quat_pred[2,:], label='Filtered prediction', linestyle='dashed')
pl.xlabel("Time (s)")
...
pl.legend()
pl.subplot(2,2,4)
pl.plot(t, quat_no[3,:], label='Measured', color='grey')
pl.plot(t, quat_th[3,:], label='Noisy estimation')
pl.plot(t, quat_pred[3,:], label='Filtered prediction', linestyle='dashed')
pl.xlabel("Time (s)")
...
pl.plot(t, omega_th[1,:], label='Theoretical rate')
pl.plot(t, omega_pred[1,:], label='Filtered prediction', linestyle='dashed')
pl.xlabel("Time (s)")
pl.ylabel(r"$\omega_x$")
pl.grid(True)
pl.legend()
...
pl.plot(t, omega_th[2,:], label='Theoretical rate')
pl.plot(t, omega_pred[2,:], label='Filtered prediction', linestyle='dashed')
pl.xlabel("Time (s)")
pl.ylabel(r"$\omega_y$")
pl.grid(True)
pl.legend()
...
pl.plot(t, omega_th[3,:], label='Theoretical rate')
pl.plot(t, omega_pred[3,:], label='Filtered prediction', linestyle='dashed')
pl.xlabel("Time (s)")
pl.ylabel(r"$\omega_z$")
pl.grid(True)
pl.legend()
